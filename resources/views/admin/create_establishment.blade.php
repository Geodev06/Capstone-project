...
<div class="row">
    <div class="col-md-5 col-lg-5">
        <form method="POST" id="add-establishment" action="{{ route('establishment.store') }}">
            @if($errors->any())
            ...
            <div class="p-3">
                ...
                <div class="mb-3 ">
                    ...
                    <div class="input-group">
                        <input type="text" value="{{ old('establishment_name') }}" name="establishment_name" autocomplete="off" placeholder="Establishment name" class="form-control" />
                    </div>
                </div>
                ...
                <div class="mb-3 ">
                    ...
                    <div class="input-group">
                        <input type="text" value="{{ old('establishment_address') }}" name="establishment_address" autocomplete="off" id="est_add" placeholder="Establishment address" class="form-control" />
                    </div>
                </div>
                ...
                <div class="mb-3 ">
                    ...
                    <div class="input-group">
                        <input type="text" value="{{ old('schedule') }}" name="schedule" autocomplete="off" placeholder="Schedules" class="form-control" />
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    <div class="mb-3 w-100">
                        ...
                        <div class="input-group">
                            <input type="number" value="{{ old('contact') }}" name="contact" autocomplete="off" class="form-control" />
                        </div>
                    </div>
                    <div class="mb-3 w-100">
                        <label for="" class="form-label text-muted">Email</label>
                        <div class="input-group">
                            <input type="text" value="{{ old('email') }}" name="email" autocomplete="off" class="form-control" />
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    <div class="mb-3 w-100">
                        ...
                        <div class="input-group">
                            <input type="text" value="{{ old('open') }}" name="open" autocomplete="off" class="form-control" />
                        </div>
                    </div>
                    <div class="mb-3 w-100">
                        <label for="" class="form-label text-muted">Close time</label>
                        <div class="input-group">
                            <input type="text" value="{{ old('close') }}" name="close" autocomplete="off" class="form-control" />
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex mb-4 justify-content-end">
                    ...
                    <input type="hidden" value="{{ old('lon') }}" name="lon" id="loni" />
                </div>
