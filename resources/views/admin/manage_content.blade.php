            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <!-- form -->
                            <form method="POST" id="add-content" action="{{ route('content.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <div class="input-group">
                                            <input type="text" value="{{ old('title') }}" name="title" autocomplete="off" placeholder="Content title" id="title" class="form-control" />
                                        </div>
                                    </div>

                                    <div class="mb-3 ">
                                        <label for="content" class="form-label text-muted">Content</label>
                                        <textarea name="content" id="" cols="30" class="form-control" rows="7">{{ old('content')}}</textarea>
                                    </div>
                            ...
                            <form method="POST" id="edit-content" enctype="multipart/form-data">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="mb-3 ">
                                        <label for="title" class="form-label text-muted">Title</label>
                                        <div class="input-group">
                                            <input id="e-title" type="text" value="{{ old('title') }}" name="title" autocomplete="off" placeholder="Content title" id="title" class="form-control" />
                                        </div>
                                    </div>

                                    <div class="mb-3 ">
                                        <label for="content" class="form-label text-muted">Content</label>
                                        <textarea name="content" id="e-content" cols="30" class="form-control" rows="5">{{ old('content')}}</textarea>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#btn-delete').on('click', function(e) {
            ...
            var uri = "{{ route('content.destroy',':id') }}"
        ...
        $('#edit-content').on('submit', function(e) {
            e.preventDefault()
            var uri = "{{ route('content.update',':id') }}"
            $.ajax({
                url: uri.replace(':id', $(this)[0].dataset.id),
                type: 'post',
                data: new FormData(this),
