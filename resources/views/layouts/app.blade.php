...
<body>
        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link {{ '/' === request()->path() ? 'active': '' }}" aria-current="page" href="{{ route('index') }}">Home</a></li>
                    ...
                    <div class="text-center text-white my-5">
                        <div class="header-container">
                            ...
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                                <a class="btn-green px-4 me-sm-3" href="{{ route('login') }}">Book Now</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-lg-3 mx-auto p-5" data-aos="fade-up" data-aos-offset="200" data-aos-delay="(300)+100">
                    <div class="h-100">
                        <img src="{{ asset($content->image) }}" alt="{{ asset($content->image) }}" height="160px" width="100%">
                        <div class="p-3">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 mx-auto p-5" data-aos="fade-right" data-aos-offset="200" data-aos-delay="300">
                    <div class="h-100 p-4">
                        <img src="{{ asset($todo->image) }}" alt="{{ asset($todo->image) }}" height="100px" width="100%">
                        <div class="p-3 ">
                            <h4 class="fw-bold text-dark">{{ $todo->title }}</h4>
                            <p class="text-muted">{{ $todo->content }}</p>
                        </div>
                    </div>
                </div>
                @endforeach
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 mx-auto p-5" data-aos="fade-right" data-aos-offset="200" data-aos-delay="300">
                    <div class="h-100 p-4 about-card">
                        <img src="{{ asset($about->image) }}" alt="{{ asset($about->image) }}" height="100px" width="100%">
                        <div class="p-3 ">
                            <h4 class="fw-bold text-dark">{{ $about->title }}</h4>
    ...
    <script>
        ...
        function load_establishments(value) {
            var route = "{{ route('establishment.guest',':value') }}";
            $.ajax({
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-4 p-5" data-aos="fade-left" data-aos-offset="200" data-aos-delay="300">
                            ...
                            <div class="d-flex p-2 align-items-baseline">
                                ...
                                <h6 class="fw-light m-2">{{ $admin[0]->phone }}</h6>
                            </div>
                            <div class="d-flex p-2 align-items-baseline">
                                <i class="bx bx-envelope m-2"></i>
                                <h6 class="fw-light m-2">{{ $admin[0]->email }}</h6>
                            </div>
