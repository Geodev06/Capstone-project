@extends($userdata->role == 1 ? 'admin.dashboard' : 'user.dashboard')
...
<div class="row p-5 my-white">
                    ...
                    <div class="p-3">
                        ...
                        <div class="mb-3 ">
                            ...
                            <div class="input-group">
                                <input id="name" type="text" value="{{ $userdata->name }}" name="name" autocomplete="off" placeholder="Name" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 ">
                            ...
                            <div class="input-group">
                                <input id="address" type="text" value="{{ $userdata->address }}" name="address" autocomplete="off" placeholder="Address" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 ">
                            ...
                            <div class="input-group">
                                <input id="email" type="text" value="{{ $userdata->email }}" name="email" autocomplete="off" placeholder="Address" disabled class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 ">
                            ...
                            <div class="input-group">
                                <input id="email" type="number" value="{{ $userdata->phone }}" name="phone" autocomplete="off" placeholder="Phone no." class="form-control" />
                            </div>
                        </div>
    ...
    <div class="col-md-8 col-lg-8 mb-3">
        <div class="card p-4 shadow-sm">
            <div class="col-lg-8 col-md-8">
                <form method="POST" action="{{ route('user.update_pass') }}">
                    @csrf
                    <div class="p-3">
                        <input type="hidden" name="id" value="{{ $userdata->id }}" />
                        <div class="mb-3 ">
    ...
    <div class="col-md-8 col-lg-8">
        <div class="card p-4 shadow-sm">
            <div class="col-lg-8 col-md-8">
                <form method="POST" action="{{ route('user.delete', $userdata->id) }}" class="p-3">
                    @csrf
