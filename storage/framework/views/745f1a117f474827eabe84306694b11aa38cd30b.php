            ...
            <div class="p-3">
                ...
                <div class="d-flex justify-content-between">
                    <div class="mb-3 w-100">
                        ...
                        <div class="input-group">
                            <input type="text" value="<?php echo e(old('open')); ?>" name="open" autocomplete="off" class="form-control" />
                        </div>
                    </div>
                    <div class="mb-3 w-100">
                        <label for="" class="form-label text-muted">Close time</label>
                        <div class="input-group">
                            <input type="text" value="<?php echo e(old('close')); ?>" name="close" autocomplete="off" class="form-control" />
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.manage_establishments', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sarah\Desktop\tanawsystem\tanaw-deploy\tanawsystem\resources\views/admin/create_establishment.blade.php ENDPATH**/ ?>