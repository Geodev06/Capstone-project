...
<div class="modal fade" id="est_modal" tabindex="-1" aria-labelledby="modal-label" aria-hidden="true">
    ...
    <script>
        ...
        function load_establishments(value) {
            var route = "<?php echo e(route('getnearby',':value')); ?>";
            $.ajax({
...
<?php echo $__env->make('user.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sarah\Desktop\tanawsystem\tanaw-deploy\tanawsystem\resources\views/user/nearby.blade.php ENDPATH**/ ?>