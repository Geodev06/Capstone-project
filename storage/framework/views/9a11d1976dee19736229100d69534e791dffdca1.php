    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 p-5">
                <h1>TANAW Report</h1>
                <P>As of <?php echo e(now()->format('M d Y')); ?></P>
                <hr>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="d-flex justify-content-between align-items-end">
                            <h5>TOTAL NO. OF PAYMENTS</h5>
                            <h2><?php echo e($data['payments']); ?></h2>
                        </div>
                        <div class="d-flex justify-content-between align-items-end">
                            <h5>TOTAL NO. OF VISTORS</h5>
                            <h2><?php echo e($data['visitors']); ?></h2>
                        </div>
                        <div class="d-flex justify-content-between align-items-end">
                            <h5>OVERALL REVENUE</h5>
                            <h2>&#8369; <?php echo e($data['revenue']); ?>.00 </h2>
                        </div>
                        <div class="d-flex justify-content-between align-items-end">
                            <h5>TOTAL NO. OF TRANSACIONS MADE</h5>
                            <h2><?php echo e($data['transactions']); ?></h2>
                        </div>
                        <div class="d-flex justify-content-between align-items-end">
                            <h5>TOTAL NO. OF USERS</h5>
                            <h2><?php echo e($data['user']); ?></h2>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <table class="table table-striped" style="font-size: 11px" id="table-recent">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $table_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="text-dark"><?php echo e($dt->payment_count); ?></td>
                                <td class="text-dark">&#8369; <?php echo e($dt->total); ?> </td>
                                <td class="text-dark"><?php echo e($dt->date); ?></td>
...
</html><?php /**PATH C:\Users\sarah\Desktop\tanawsystem\tanaw-deploy\tanawsystem\resources\views/admin/report.blade.php ENDPATH**/ ?>