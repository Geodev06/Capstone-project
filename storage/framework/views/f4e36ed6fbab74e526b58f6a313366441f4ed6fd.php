...
<div class="row">
    <div class="col-md-5 col-lg-3 shadow-sm" style="height: 80vh; overflow-y:scroll">
        ...
        <div class="row" id="msg_section2">
            <?php for($i = 0; $i< count($user_data); $i++): ?> <div class="col-lg-12 mb-2 user-div user_chat" style="cursor: pointer;" data-name="<?php echo e(strtolower($user_data[$i]['user']->sender_name)); ?>" data-message_id="<?php echo e($user_data[$i]['user']->message_id); ?>">
                <div class="user-card p-3 d-flex align-items-center <?php echo e($user_data[$i]['user']->has_unread? 'has_unread':''); ?> ">
                    <div class="avatar-container m-3">
                        <span class="m-3 avatar">A</span>
                    </div>
                    <div class="d-flex flex-column">
                        <span class="fw-bold" style="font-size: 14px;"> <?php echo e($user_data[$i]['user']->sender_email); ?></span>
                        <span class="fw-light text-muted" style="font-size: 12px;"> <?php echo e($user_data[$i]['user']->sender_name); ?></span>
                    </div>
                    <?php if($user_data[$i]['unread'] > 0): ?>
                    <div>
                        <span class="badge bg-danger m-2"><?php echo e($user_data[$i]['unread']); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
        </div>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sarah\Desktop\tanawsystem\tanawsystem\resources\views/admin/message.blade.php ENDPATH**/ ?>