        ...
        <script>
            ...
            $('#btn-mark').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        var route = "<?php echo e(route('room.mark', ':id')); ?>"
...
<?php echo $__env->make('admin.manage_room', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sarah\Desktop\tanawsystem\tanaw-deploy\tanawsystem\resources\views/admin/room_info.blade.php ENDPATH**/ ?>