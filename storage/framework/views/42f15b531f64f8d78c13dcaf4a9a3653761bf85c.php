...
<head>
    ...
    <title><?php echo e($payment[0]->payment_id); ?></title>
    ...
    <div class="container-fluid">
        <div class="row p-5">
            ...
            <div class="col-md-12 col-lg-5 mt-5">
                <a href="<?php echo e(route('user.dashboard')); ?>" class="float-end w-auto ">To dashboard</a>
                <h1 class="fw-bold">Payment Success!</h1>
                <h2 class="fw-bold">Tanaw UI</h2>
                <div class="my-card p-3">
                    <p>Receipt Id : <span id="rid"></span></p>
                    <p>Payment Id : <span><?php echo e($payment[0]->payment_id); ?></span></p>
                    <p>Payer Id : <span><?php echo e($payment[0]->payer_id); ?></span></p>
                    <p>Paypal Email : <span><?php echo e($payment[0]->payer_email); ?></span></p>
                    <hr>
                    <div class="info-container">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <p class="fw-bold text-muted" style="font-size: 10px;">NAME</p>
                                <span class="fw-bold "><?php echo e($details[0]->checker_name); ?></span>
                            </div>
                            <div class="col-md-6 mb-3 d-flex justify-content-between">
                                <div>
                                    <p class="fw-bold text-muted" style="font-size: 10px;">ADDRESS</p>
                                    <span class="fw-bold"><?php echo e($details[0]->address); ?></span>
                                </div>
                                <div>
                                    <p class="fw-bold text-muted" style="font-size: 10px;">PHONE</p>
                                    <span class="fw-bold"><?php echo e($details[0]->mobile); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div>
                                    ...
                                    <span class="fw-bold"><?php echo e($details[0]->email); ?></span>
                            ...
                            <div class="col-md-8 mb-3 text-end">
                                ...
                                <span class="fw-bold text-success text-uppercase"><?php echo e($payment[0]->payment_status); ?></span>
                            </div>
                            <div class="col-md-6">
                                <p class="fw-bold text-muted" style="font-size: 10px;">CHECK IN DATE</p>
                                <span class="fw-bold "><?php echo e($details[0]->target_date); ?></span>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <span class="fw-bold fs-4 text-muted"><?php echo e($details[0]->plan); ?></span>
                            </div>
                            <div class="col-md-8">
                    ...
                    <hr>
                    <p>Payment date: <?php echo e($details[0]->created_at->format(' jS, \of F, Y  g:i  A')); ?></p>
...
<script>
    var rid = "<?php echo e($payment[0]->id); ?>"
    document.querySelector('#rid').innerHTML = rid.padStart(8, '0')

    var amount = "<?php echo e($payment[0]->amount); ?>"
    ...
    function makeCode(data, filename) {
        ...
        setTimeout(() => {
            ...
            dl.setAttribute('download', "<?php echo e($payment[0]->payment_id); ?>")
            dl.removeAttribute('hidden')
        }, 500)
    }
    const data = "<?php echo e(route('check_in.receipt',$payment[0]->payment_id)); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\sarah\Desktop\tanawsystem\tanawsystem\resources\views/user/check_in_receipt.blade.php ENDPATH**/ ?>