    ...
    function load_data() {
        ...
        return $.ajax({
            ...
            for (let i = 0; i < data.users.length; i++) {
                ...
                var button = '<button class="btn btn-sm btn-warning">Remove</button>'
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tanawsystem\resources\views/admin/users.blade.php ENDPATH**/ ?>