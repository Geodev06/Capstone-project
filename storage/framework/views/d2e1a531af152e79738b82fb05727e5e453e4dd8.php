    ...
    $(document).ready(function() {
        ...
        $('#btn-open-link').on('click', function() {
            ...
            if ($(this)[0].dataset.type !== 'entrance') {
                ...
                var route_2 = "<?php echo e(route('entrance.receipt',':id')); ?>"
        ...
        $('#btn-approve-request').click(function() {
            ...
            if ($(this)[0].dataset.status === 'on-cancel-request') {
                Swal.fire({
                    ...
                    if (result.value) {
                        var route = "<?php echo e(route('booking.cancel.approve',':id')); ?>"
                        return $.ajax({
        ...
        $('#btn-accept-payment').click(function() {
            ...
            if ($(this)[0].dataset.status === 'to-approve') {
                Swal.fire({
                    ...
                    if (result.value) {
                        var route = "<?php echo e(route('payment.accept',':id')); ?>"
                        return $.ajax({
                            url: route.replace(':id', $(this)[0].dataset.id),
                            type: 'get',
                            dataType: 'json',
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sarah\Desktop\tanawsystem\tanaw-deploy\tanawsystem\resources\views/admin/user_payments.blade.php ENDPATH**/ ?>